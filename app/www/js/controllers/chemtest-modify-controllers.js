angular.module('starter.chemtest-modify-controllers', [])


.controller('ChemTestDetailCtrl', function($scope, $rootScope, $ionicPopup, $ionicModal, $state, MembershipService, $location, $stateParams, BioTest, AuthService, filterFilter) {
  ...
  $scope.addRecord = function(result){

    if(result){
      $scope.record.result = 'Passed';
    } else {
      $scope.record.result = 'Failed';
    }
